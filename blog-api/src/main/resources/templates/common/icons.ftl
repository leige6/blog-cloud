<link rel="stylesheet" type="text/css" href="/css/icons-view.css?v=60" />
    ...
    <div class="interchange-body">
        <div id="clipIcon" class="large-12 columns">
            ...
            <ul class="small-block-grid-2 large-block-grid-4">
                ...
                <li>
                    <p>
                        <i class="fi-upload"></i> com.baidu.ueditor.upload
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <i class="fi-upload-cloud"></i> com.baidu.ueditor.upload-cloud
                    </p>
                </li>
                <li>
                    <p>
