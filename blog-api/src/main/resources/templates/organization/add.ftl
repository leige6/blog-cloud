    ...
    <form id="organizationAddForm" method="post">
        <table class="grid">
            <tr>
                ...
                <td>部门编码</td>
                <td><input name="code" type="text" placeholder="请输入部门编码" class="easyui-validatebox" data-options="required:true" ></td>
            </tr>
            <tr>
                <td>排序</td>
            ...
            <tr>
                <td>地址</td>
                <td colspan="3"> <input class="easyui-textbox" name="address" data-options="multiline:true" style="height:100px;width:300px"/></td>
            </tr>
            <tr>
                <td>上级部门</td>
