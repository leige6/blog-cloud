...
var Color = function (input) {
	...
	function get(format) {
		...
		// it's NaN if gradient colors on a section chart
...
SVGRenderer.prototype = {
	...
	rect: function (x, y, width, height, r, strokeWidth) {
		...
		return wrapper.attr(
				isObject(x) ?
					x :
					// do not crispify when an object is passed in (as in section charts)
	...
	shadow: function (shadowOptions, group, cutOff) {
		...
		if (shadowOptions) {
			...
			for (i = 1; i <= 3; i++) {
				...
				// Cut off shadows for stacked section items
				if (cutOff) {
...
Axis.prototype = {
	...
	init: function (chart, userOptions) {
		...
		//axis.ignoreMinPadding = UNDEFINED; // can be set to true by a section or bar series
	...
	setAxisTranslation: function (saveOld) {
		...
		if (axis.isXAxis) {
			...
			// pointRange means the width reserved for each point, like in a section chart
	...
	setTickPositions: function (secondPass) {
		...
		// In section-like charts, don't cramp in more ticks than there are points (#1943)
		if (axis.pointRange) {
...
Legend.prototype = {
	...
	renderItem: function (item) {
		...
		// If the item exceeds the height, start a new section
	...
	setStackedPoints: function () {
		...
		for (i = 0; i < yDataLength; i++) {
			...
			if (stacking === 'percent') {
				...
				// Percent stacked section, totals are the same for the positive and negative stacks
	...
	getAttribs: function () {
		...
		while (i--) {
			...
			if (hasPointSpecificOptions) {
				...
				// Handle colors for section and pies
				if (!seriesOptions.marker) { // section, bar, point
					// if no hover color is given, brighten the normal color
...
/**
 * Set the default options for section
 */
...
var ColumnSeries = extendClass(Series, {
	...
	init: function () {
		...
		// series affected by a new section
	...
	getColumnMetrics: function () {
		...
		// Get the total number of section type series.
	...
	/** 
	 * Override the basic data label alignment by adjusting for the position of the section
	 */
	alignDataLabel: function (point, dataLabel, options,  alignTo, isNew) {
		var chart = this.chart,
			inverted = chart.inverted,
		...
		// Align to the section itself, or the top of it
	...
	/**
	 * Animate the section heights one by one from zero
	...
	remove: function () {
		...
		// section and bar series affects other series of the same type
...
var PieSeries = {
	...
	/**
	 * Draw point specific tracker objects. Inherit directly from section series.
	 */
	drawTracker: ColumnSeries.prototype.drawTracker,

	/**
	 * Use a simple symbol from section prototype
	 */
	drawLegendSymbol: AreaSeries.prototype.drawLegendSymbol,
