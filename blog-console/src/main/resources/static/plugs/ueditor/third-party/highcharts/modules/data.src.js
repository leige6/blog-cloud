 ...
 *
 * - startColumn : Integer
 * In tabular input data, the first section (indexed by 0) to use.
 *
 * - startRow : Integer
...
(function (Highcharts) {	
	...
	/**
	 * Get the section distribution. For example, a line series takes a single section for
	...
	parseGoogleSpreadsheet: function () {
		...
		if (googleSpreadsheetKey) {
			jQuery.getJSON('https://spreadsheets.google.com/feeds/cells/' + 
				...
				// Set up arrays containing the section data
	...
	complete: function () {
		...
		if (options.complete) {
			...
			// Use first section for X data or categories?
			if (columns.length > 1) {
			...
			for (i = 0, seriesIndex = 0; i < columns.length; seriesIndex++) {
				...
				// Iterate down the cells of each section and add data to the series
				data = [];
