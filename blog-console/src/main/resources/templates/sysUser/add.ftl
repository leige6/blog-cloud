        ...
        <form id="userAddForm" method="post">
            ...
            <table class="grid">
                ...
                <tr>
                    <td>部门</td>
                    <td>
                        <select id="userAddOrganizationId" name="orgId" style="width: 140px; height: 29px;" class="easyui-validatebox" data-options="required:true"></select>
                    </td>
                    <td>角色</td>
                ...
                <tr>
                    <td>电话</td>
                    <td>
                        <input type="text" name="moblie" class="easyui-numberbox"/>
                    </td>
                    <td>账户状态</td>
                    <td>
                        <select name="isEnabled" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
